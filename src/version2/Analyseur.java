 ...
 * <p>
 * Version 2 : identique à la version 1, avec propagation des erreurs de
 * débordement via le retour booléen de {@link Source#suivant()}.
 * </p>
 * <pre>
 * E -&gt; S ;
 * S -&gt; P | P + S
...
public class Analyseur {
    ...
    /**
     * Point d'entrée de l'analyse. Affiche un message selon le résultat.
     */
